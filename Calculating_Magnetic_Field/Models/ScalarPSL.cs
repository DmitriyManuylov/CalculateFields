...
namespace Calculating_Magnetic_Field.Models
{
    ...
    public class ScalarPSL : IPotencial
    {
        ...
        public double Calculate_Potencial_from_Element(PointD pointM, Rib ribN)
        {
            ...
            double length = ribN.LengthOfElement;
        ...
        public double KernelOfIntegral(Rib ribN, Rib ribM)
        {
            ...
            return ((pointM.X - pointN.X) * ribM.Normal.CosAlpha + (pointM.Y - pointN.Y) * ribM.Normal.CosBeta) / r2;
        }
        public double Integral_dAdn(Rib ribN, Rib ribM)
        {
            ...
            return ribN.LengthOfElement * ((pointM.X - pointN.X) * ribM.Normal.CosAlpha + (pointM.Y - pointN.Y) * ribM.Normal.CosBeta) / r2;
        }
