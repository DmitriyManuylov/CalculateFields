...
namespace Calculating_Magnetic_Field
{
    ...
    /// <summary>
    /// Класс, представляющий катушку
    /// </summary>
    public class Coil: IVolumeSource, ISource
    {
        ...
        /// <param name="n"></param>
        /// <param name="m"></param>
        public Coil(Bound_Rectangle rectangle, double current, int n, int m)
        {
            this.n = n;
            this.m = m;
            //coef 
            ...
            SourcePower = current;
            CurrentDensity = SourcePower / rectangle.GetSquare();
        ...
        public Vector2D GetInductionValue(PointD PointM)
        {
            ...
            result *= standart_field_property / (2d * Math.PI) * CurrentDensity;
            return -result;
        }
        ...
        {
            SourcePower = current;
            CurrentDensity = SourcePower / Bound_Rectangle.GetSquare();
        }
        ...
        public Vector2D GetIntensityValue(PointD PointM)
        {
            ...
            result *= 1d / (2d * Math.PI) * CurrentDensity;
            return -result;
        }
    }
}
